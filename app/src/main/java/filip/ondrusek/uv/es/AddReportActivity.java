...
public class AddReportActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
   private final String[] optionsSpinner = { "No" , "Yes" };
   ...
   private EditText diagnosticCode, etSearch;
   ...
   private final MunicipalityDetailActivity municipalityDetail = new MunicipalityDetailActivity();
   ...
   private SQLiteDatabase database;
    ...
    private String[] getReportActivityValues()
    {
        ...
        String dateS = this.day + "/" +
                this.month + "/" + this.year;
        String isCheckedS = Boolean.toString((feverChills).isChecked());
        String coughS = Boolean.toString((cough).isChecked());
        String breathingS = Boolean.toString((breathing).isChecked());
        String fatigueS = Boolean.toString((fatigue).isChecked());
        String bodyAchesS = Boolean.toString((bodyAches).isChecked());
        String headacheS = Boolean.toString((headache).isChecked());
        String lossTasteS = Boolean.valueOf((lossTaste).isChecked()).toString();
        String soreThroatS = Boolean.valueOf((soreThroat).isChecked()).toString();
        String congestionRunnyNoseS = Boolean.toString((congestionRunnyNose).isChecked());
        String nauseaVomitingS = Boolean.valueOf((nauseaVomiting).isChecked()).toString();
        String diarrheaS = Boolean.valueOf((diarrhea).isChecked()).toString();
    ...
    {
        reportDbHelper.updateReport(database, reportValues(), this.report.getDiagnosticCode());
    }
